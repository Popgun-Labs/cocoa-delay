...
public:
	...
	void Process(double dt, double inL, double inR, double cutoff, double &outL, double &outR, bool highPass = false) override
	{
...
{
public:
	MultiFilter(); // Added constructor to initialize unique_ptrs
